package com.myshopify.getpageobjects;

import static com.myshopify.utilities.DataPropertFileUtil.getProperty;
...
import com.myshopify.utilities.SeleniumWait;
...
public class BaseUi {
	...
	public void clickOnButton(WebElement element,String text) {
			...
			element.click();
			logMessage("User enters the button: "+ text);	
		}
